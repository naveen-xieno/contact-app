<div class="row">
    <div class="col-md-12">
      <div class="form-group row">
        ...
        <div class="col-md-9">
          {{-- <input type="text" name="first_name" id="first_name" value="{{ request()->old('first_name','John')}}" class="form-control @error('first_name') is-invalid @enderror"> --}}
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <textarea name="address" id="address" rows="3" value="{{ old('address', $contact->address)}}" class="form-control @error('address') is-invalid @enderror"></textarea>
          @error('address')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="col-md-9">
          <select name="company_id" id="company_id" class="form-control @error('company_id') is-invalid @enderror">
            ...
            @foreach($companies as $id => $company)
                <option value="{{ $id }}" @if ($id == old('company_id', $contact->company_id)) selected @endif>{{ $company }}</option> 
            @endforeach 
          </select>
          @error('company_id')
